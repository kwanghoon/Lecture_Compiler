package org.swlab.examples.arith.comp.test;
...
import org.swlab.examples.arith.ast.Interp;
import org.swlab.examples.arith.ast.test.InterpTest;
import org.swlab.examples.arith.vm.Instr;
import org.swlab.examples.arith.vm.VM;
...
class CompilerTest {
	...
	void test() {
		...
		ArrayList<Instr> instrs = 
				org.swlab.examples.arith.comp.Compiler.compile(exprSeq);
