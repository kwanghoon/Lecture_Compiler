package org.swlab.examples.arith.ast.test;
...
import org.swlab.examples.arith.ast.*;

public class InterpTest {

	@Test
	void test() {
		ArrayList<Expr> exprList =  exampleExpr1();
	...
	public static ArrayList<Expr> exampleExpr1() {
